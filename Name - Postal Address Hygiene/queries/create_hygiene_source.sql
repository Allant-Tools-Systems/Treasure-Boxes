...
, cast(TO_UNIXTIME(current_timestamp) as BIGINT)
  from (select 'hygiene_sample_01' as ${hygiene.key_column}
         ...
         union all
        select 'hygiene_sample_02' as ${hygiene.key_column}
         ...
         union all
        select 'hygiene_sample_03' as ${hygiene.key_column}
         ...
         union all
        select 'hygiene_sample_04' as ${hygiene.key_column}
         ...
         union all
        select 'hygiene_sample_05' as ${hygiene.key_column}
         ...
         union all
        select 'hygiene_sample_06' as ${hygiene.key_column}
         ...
         union all
        select 'hygiene_sample_07' as ${hygiene.key_column}
         ...
         union all
        select 'hygiene_sample_08' as ${hygiene.key_column}
         ...
         union all
        select 'hygiene_sample_09' as ${hygiene.key_column}
